...
// Create the document if it doesn't exist yet, then patch only the priceCalculator field
...
console.log('\n✓ Price calculator defaults written to Sanity siteSettings.\n')
console.log('Refresh /studio → Site Settings to see the values.\n')
